                        ...
                        <div class="card-parent" data-id="${job.id}">
                            ...
                            <div class="card-meta-info">
                                <div class="meta-item">
                                    ...
                                    <span>${fn:escapeXml(job.location)}</span>
                                </div>
                                <div class="meta-item">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill="#787774" class="meta-icon">
                                        <path d="M441-120v-86q-53-12-91.5-46T293-348l74-30q15 48 44.5 73t77.5 25q41 0 69.5-18.5T587-356q0-35-22-55.5T463-458q-86-27-118-64.5T313-614q0-65 42-101t86-41v-84h80v84q50 8 82.5 36.5T651-650l-74 32q-12-32-34-48t-60-16q-44 0-67 19.5T393-614q0 33 30 52t104 40q69 20 104.5 63.5T667-358q0 71-42 108t-104 46v84h-80Z"/>
                                    </svg>
                                    <span>${fn:escapeXml(job.salaryRange)}</span>
                                </div>
                                <div class="meta-item">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill="#787774" class="meta-icon">
                            ...
                            <div class="card-content-parent">
                                <div class="card-description">
                                        ${fn:escapeXml(fn:substring(job.description, 0, 100))}${fn:length(job.description) > 100 ? '...' : ''}
                                </div>
                            </div>
                        </div>
                        </a>
